...
\graphicspath{{./}{./fig/}{./fig/CAD-Modeling/}{./fig/Multibody-Modeling/}{./fig/controller/}{./fig/aa-titel/}{./fig/Project_description_and_requirements/}}
...
\usepackage{subcaption} % Unterstuetzung fuer subfigure
...
\definecolor{vscodeBorder}{RGB}{210, 210, 210}
\definecolor{vscodeLineNum}{RGB}{140, 140, 140}

\lstdefinestyle{vscodelight}{
    backgroundcolor=\color{vscodeBg},
    basicstyle=\ttfamily\small\color{black},
    commentstyle=\color{vscodeComment}\itshape,
    keywordstyle=\color{vscodeKeyword}\bfseries,
    numberstyle=\tiny\color{vscodeLineNum},
    morekeywords={function, return, clamp},
    morecomment=[l]{//},
    numbers=left,
    numbersep=8pt,
    frame=single,
...
\lstset{      
   ...
   keywordstyle =, % \bfseries\color{blue}	  % Schlsselwort-Style
...
% Aussehen der Captions fuer subfigures (subcaption-Paket)
...
\newcommand{\sectionauthor}[1]{%
	\par\smallskip
	{\small\textit{Author and responsibility during the project: #1}}
	\par\medskip
}